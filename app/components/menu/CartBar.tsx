    ...
    <div className="fixed bottom-0 left-0 right-0 z-20 p-3">
      <div className="bg-brand rounded-2xl px-4 py-3 flex items-center justify-between shadow-lg max-w-lg mx-auto">
        ...
        <button
          ...
          disabled={isPending}
          className="bg-brand-light text-brand font-bold text-sm px-5 py-2.5 rounded-pill flex items-center gap-1.5 active:scale-95 transition-transform disabled:opacity-60"
        >
