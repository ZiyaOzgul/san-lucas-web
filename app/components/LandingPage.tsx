    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-8 overflow-hidden bg-[url('/background.png')] bg-cover bg-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <motion.div {...fadeUp(0.38)}>
          <Link
            href={menuHref}
            className="inline-flex items-center gap-2 bg-brand-light text-brand font-bold px-8 py-3.5 rounded-pill text-sm shadow-lg active:scale-95 transition-transform"
          >
            Menüyü Gör
            <svg
              width="16"
